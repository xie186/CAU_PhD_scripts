...
for(my $i=0;$i<@file;++$i){
    ...
    if($aa[2]!~/exon/ && $aa[2]!~/intron/ && $aa[2]!~/mRNA/){
        ...
        if ($aa_up[2] eq "mRNA"){
            $aa[2]="single_exon";
        }elsif(($aa_up[2] eq "intron" && $aa[6] eq "+") ||($aa_up[2] eq "exon" && $aa[6] eq "-" && $aa_down[2] eq "CDS")){
            $aa[2]="first_exon";
        ...
        if($aa_up[2] eq "mRNA" && $aa_down[2] eq "exon"){
            $aa[2]="single_intron";
        }elsif(($aa_up[2] eq "mRNA" && $aa[6] eq "+" && $aa_down[2] eq "intron") || ($aa_up[2] eq "intron" && $aa_down[2] eq "exon" && $aa[6] eq "-")){
            $aa[2]="first_intron";
       }else{
