meth_dis_gene_tis<-function(maternal,paternal,context,PDF){
    ...
    legend(1,max*0.9*100, c("156","c24"), cex=0.8, col=c(rgb(74,126, 187,96,160,max = 255), rgb(190,75,72,max = 255)), pch=".",lty=1, ,lwd=2);
    dev.off();
}
