meth_dis_gene_tis<-function(maternal,paternal,shoot,embryo,endoBB,context,PDF){
    ...
    max<-max(mat[,3],pat[,3],sd[,3],em[,3],enBB[,3]);
    ...
    lines(sd[,3]*100, col = rgb(152,185,84,max = 255),lwd=1.5);  ## green
    ...
    legend(1,max*0.9*100, c("156","204","nrpd1a","ros1","c24"), cex=0.8, col=c(rgb(74,126, 187,96,160,max = 255), rgb(190,75,72,max = 255), rgb(152,185,84,max = 255), rgb(125,96,160,max = 255), rgb(70,170,197,max = 255)), pch=".",lty=1, ,lwd=2);
    dev.off();
}
