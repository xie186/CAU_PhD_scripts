...
my ($dmr,$cpg_ot1,$cpg_ob1,$chg_ot1,$chg_ob1,$chh_ot1,$chh_ob1,$cpg_ot2,$cpg_ob2,$chg_ot2,$chg_ob2,$chh_ot2,$chh_ob2,$out)=@ARGV;

my %meth_alle1;
foreach my $bed ($cpg_ot1,$cpg_ob1,$chg_ot1,$chg_ob1,$chh_ot1,$chh_ob1){
...
my %meth_alle2;
foreach my $bed($cpg_ot2,$cpg_ob2,$chg_ot2,$chg_ob2,$chh_ot2,$chh_ob2){
