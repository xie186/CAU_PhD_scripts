...
#    `samtools merge -r $gene.merge.bam @bam_file`;
    `samtools mpileup -uf $ref @bam_file -l $gene_region |/NAS1/software/samtools/bcftools/bcftools view -bvcg - |/NAS1/software/samtools/bcftools/bcftools view - |/NAS1/software/samtools/bcftools/vcfutils.pl varFilter -D100 > $gene.var.flt.vcf`;
