draw_mth_dis_ele_RPKM10<-function(cg_low,cg_high){
    cg<-read.table(cg_low) 
    cg_high<-read.table(cg_high)
    cg<-cg[order(cg[,2]),]
    max<-max(cg[,3],cg[,4],cg[,5],cg[,6],cg[,7],cg[,8],cg[,9],cg[,10],cg[,11],cg[,12],cg_high[,3],cg_high[,4],cg_high[,5],cg_high[,6],cg_high[,7],cg_high[,8],cg_high[,9],cg_high[,10],cg_high[,11],cg_high[,12])
