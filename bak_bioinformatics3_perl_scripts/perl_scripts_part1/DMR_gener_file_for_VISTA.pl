...
while(<REGION>){
    chomp;
    my ($chr2, $stt2, $end2, $strand2, $chr1, $stt1, $end1, $strand1) = split;
    ...
    &plotfile($chr2, $stt2, $end2, $strand2, $chr1, $stt1, $end1, $strand1);
    print CMD "java Vista $chr2\_$stt2\_$end2\_$chr1\_$stt1\_$end1.plotfile\n";
}

sub plotfile{
    my ($chr2, $stt2, $end2, $strand2, $chr1, $stt1, $end1, $strand1) = @_;
