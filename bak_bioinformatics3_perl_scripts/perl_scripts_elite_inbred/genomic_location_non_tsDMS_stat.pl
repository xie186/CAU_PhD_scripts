...
print "$context\_non-sDMS\t$sDMPs_result_intergenic\t$sDMPs_result_downstream\t$sDMPs_result_upstream\t$sDMPs_result_intro\t$sDMPs_result_exon\t$sDMPs_result_transposon\n";
print "$context\_non-tDMS\t$pDMPs_result_intergenic\t$pDMPs_result_downstream\t$pDMPs_result_upstream\t$pDMPs_result_intro\t$pDMPs_result_exon\t$pDMPs_result_transposon\n";

sub usage{
	my $die =<<DIE;
	usage:perl *.pl <annotation_file> <context>
DIE
}
