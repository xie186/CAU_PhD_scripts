...
while(<BM>){
    chomp;
    ++ $win_stat1;
    my ($chr,$stt,$end,$c_cov1,$c_nu1,$t_nu1,$mth_lev1,$c_cov2,$c_nu2,$t_nu2,$mth_lev2) =split;
    $hash_bm{"$chr\t$stt\t$end"} = "$c_cov1\t$c_nu1\t$t_nu1\t$mth_lev1\t$c_cov2\t$c_nu2\t$t_nu2\t$mth_lev2";
}
close BM;
open MB,$mb or die "$!";
my %hash_mb;
while(<MB>){
    ...
    ++ $win_stat2;
    my ($chr,$stt,$end,$c_cov1,$c_nu1,$t_nu1,$mth_lev1,$c_cov2,$c_nu2,$t_nu2,$mth_lev2) =split;
    $hash_mb{"$chr\t$stt\t$end"} = "$c_cov1\t$c_nu1\t$t_nu1\t$mth_lev1\t$c_cov2\t$c_nu2\t$t_nu2\t$mth_lev2";
}
close MB;
