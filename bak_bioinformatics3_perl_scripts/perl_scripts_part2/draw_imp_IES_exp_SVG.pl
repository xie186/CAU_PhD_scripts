...
while(<SNP>){
    chomp;
    my @tem3=split;
    if(exists $snp_bm{$tem3[1]} && exists $snp_mb{$tem3[1]}){
        $tem3[2] = $snp_bm{$tem3[1]} *  $tem3[2]  / ($tem3[2] + $tem3[3]);
        $tem3[3] = $snp_bm{$tem3[1]} *  $tem3[3]  / ($tem3[2] + $tem3[3]);
        $tem3[4] = $snp_mb{$tem3[1]} *  $tem3[4]  / ($tem3[4] + $tem3[5]); 
        $tem3[5] = $snp_mb{$tem3[1]} *  $tem3[5]  / ($tem3[4] + $tem3[5]);
    }
