...
use strict;use DBI;
die "\n",usage(),"\n" unless @ARGV==8;
my ($tissue,$forw,$rev,$pos,$type,$length_cut,$bin_cut,$out)=@ARGV;
...
sub usage{
    my $die=<<DIE;
    perl *.pl <Tissue> <Forword> <Reverse> <Genes> <Types> <Length cutoff> <Bin cutoff> <OUTPUT>
