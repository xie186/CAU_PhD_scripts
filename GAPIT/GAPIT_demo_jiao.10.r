...
groupFrom=200,			#Lower bound for number of group
groupTo=280,			#Upper bound for number of group
groupBy=5,				#rang between 1 and number of individuals, smaller the finner optimization 
